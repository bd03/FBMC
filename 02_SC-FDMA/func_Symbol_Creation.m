function [m,bits,output] = func_Symbol_Creation(num_bits,bits_per_sample, N, num_symbols,modulation)
...
%
% Dependencies: modulation, num_symbols, bits_per_sample, N, num_bits
...
m = reshape(bi2de(reshape(bits,bits_per_sample,N*num_symbols).','left-msb'),N,num_symbols);
...
output = qam_m/sqrt(normalization(log2(modulation)/2));